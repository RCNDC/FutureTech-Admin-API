...
userRoutes.delete('/:id', [AuthAPIKey, AuthGuard], (req: Request, res: Response) => userController.deleteUser(req, res));
userRoutes.patch('/:id', [AuthAPIKey, AuthGuard], (req: Request, res: Response) => userController.editUser(req, res));
